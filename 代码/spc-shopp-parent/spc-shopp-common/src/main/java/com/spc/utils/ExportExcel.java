...
public class ExportExcel {
    ...
    private static void doExportExcel(String sheetName,String titleName,String[] headers,Collection<?> dataSet,String resultUrl,String pattern) {
        ...
        // 设置[标题]样式
        //titleStyle.setFillForegroundColor(HSSFColor.LIGHT_BLUE.index);//前景填充色
        ...
        //设置[标题]字体
       // titleFont.setColor(HSSFColor.WHITE.index);//标题颜色
        ...
        //设置[列首]字体
        //headersFont.setColor(HSSFColor.VIOLET.index);//设置颜色
        headersFont.setFontHeightInPoints((short) 12);//设置行高
        headersFont.setBoldweight(HSSFFont.BOLDWEIGHT_BOLD);//加粗
        // 把[列首字体]应用到[列首样式]
        ...
        dataSetStyle.setVerticalAlignment(HSSFCellStyle.VERTICAL_CENTER);//水平垂直居中
        // 创建[表中数据]字体
        ...
        titleCell.setCellValue(titleName);//设置单元格内容
