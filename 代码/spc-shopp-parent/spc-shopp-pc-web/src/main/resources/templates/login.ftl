...
<body
	...
	<div class="ny-header">
		<div class="nb">
			<div class="logo">
				<a href="/index.html"><img src="https://demo.yunec.cn/static/images/logo.png"
	...
	<div class="nb">
		<div class="ny-body ny-zsy">
			<div class="left">
				<img src="https://demo.yunec.cn/view/default/images/login-pic.jpg" alt="" />
			</div>
			<div class="right">
				<div class="form-box">
					...
					<div class="hezuo oauth">
						<h4>合作网站帐号登录</h4>
						<ul>
							<li><a href="http://127.0.0.1/locaWXLogin" class="wx">微信</a></li>
							<li><a href="http://127.0.0.1/locaQQLogin" class="qq">QQ</a></li>
							
  							<li><a href="https://openauth.alipaydev.com/oauth2/publicAppAuthorize.htm?app_id=2016091300503210&scope=auth_user&redirect_uri=http://127.0.0.1/zfbLoginCallback" class="zfb">支付宝第三方登录</a></li>
 							<li><a href="http://127.0.0.1/sinaLogin" class="wb">新浪</a></li>
						</ul>
	...
	<script>
		...
		function refreshimage(clickidimg) {
			clickidimg.src = '/https://demo.yunec.cn/vcode-M.html?1529157344000' + '?' + Date.parse(new Date());
		}
		function showvode() {
			document.getElementById('mx').style.display = 'block';
		}
		document.getElementById('mx').src = '/https://demo.yunec.cn/vcode-M.html?1529157344000' + '?'
				+ Date.parse(new Date());
		function refreshimage(clickidimg) {
