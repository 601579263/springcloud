...
<#if username ??>
<h1>欢迎:${username}</h1>
<a href="http://localhost:80/book.xls">下载导入模板</a>
</#if>
<a href="http://localhost:80/queryOrderList">订单查询</a>
...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<!-- alipay.trade.page.pay.jsp 付款接口 -->
		<form name=alipayment action="alipayTradePagePay" method=post
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dt>商品描述：</dt>
					<dd>
						<input id="WIDbody" name="WIDbody" value="商品描述" readonly="readonly"/>
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
